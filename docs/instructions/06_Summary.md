...
- **Submitted a real RFT job** — uploaded data, embedded the grader, and launched a fine-tuning job on Azure AI Foundry
...
|----------|-------------|
| **01 – Introduction & Setup** | Connected to Azure AI Foundry, verified environment |

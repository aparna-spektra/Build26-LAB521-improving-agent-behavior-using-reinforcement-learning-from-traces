...
## 📘 Lab Scenario
In this lab, you will work through the notebook src\data\05-training-results-evaluate.ipynb and execute each code cell in sequence to complete the workflow successfully.
...
RFT_MODEL = "rft-v7-py80"  # <-- pre-deployed by facilitator
